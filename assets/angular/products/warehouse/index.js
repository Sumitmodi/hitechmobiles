app.controller('kendoCtrl', function ($scope, $requestFactory) {
    ...
    $scope.deleteSelected = function () {
        ...
        if (ids.length > 0) {
            ...
            if (confirm("Are you sure you want to delete " + ids.length + " warehouses?") === false) {
            ...
            hitech.request({
                ...
                complete: function (result) {
                    ...
                    if (result.code == 200) {
                        ...
                        $.notify("Selected warehouses were deleted successfully.", {
                        ...
                        $.notify("Selected warehouses could not be deleted.", {
            ...
            $.notify("Please select at least one warehouse.", {
            ...
            first: {
                ...
                complete: function (result) {
                    ...
                    if (result.code === 200) {
                        ...
                        $.notify("Warehouses have been reset successfully.", {
                        ...
                        hitech.request({
                            ...
                            complete: function (res) {
                                ...
                                if (res != false) {
                                    ...
                                    $.notify("Warehouses have been reloaded.", {
                                    ...
                                    $.notify("Warehouses could not be reloaded.", {
                        ...
                        $.notify("Warehouses could not be reset.", {
    ...
    var dataSource = new kendo.data.DataSource({
        ...
        transport: {
            ...
            create: {
                ...
                url: base + 'api/customers/warehouse',
            ...
            destroy: {
                ...
                url: base + 'api/customers/deleteHouses',
    ...
    $scope.mainGridOptions = {
        ...
        toolbar: [
...

            {
                ...
                template: '<a href="javascript:;" ng-click="deleteSelected()" class="k-button k-button-icontext k-grid-delete"><span class="k-icon k-delete"></span>Delete</a>'
