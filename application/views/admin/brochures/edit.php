    ...
    <div class="table-responsive">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <table class="table table-bordered" cellpadding="5" cellspacing="0">
                <tr>
                    <th colspan="2">
                        <?= (!empty($resultArr) ? "Edit" : "Add") ?> Brochures
                    </th>
                </tr>
                <tr>
                    <td>Image</td>
                    <td><?php if (!empty($resultArr)) { ?>
                            <img src="<?= $this->config->item('brochures_url') . 't_' . $resultArr['image'] ?>" />
                        <?php } ?>
                ...
                <tr>
                    <td>Upload PDF</td>
                    <td><?php if (!empty($resultArr)) { ?>
                            <a href="<?= $this->config->item('brochures_url') . $resultArr['pdf'] ?>" target="_blank">LINK</a>
                        <?php } ?>
