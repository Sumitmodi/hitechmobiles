    ...
    <div class="table-responsive">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <table class="table table-bordered" cellpadding="5" cellspacing="0">
                <tr>
                    <th colspan="2">
                        <?= (!empty($resultArr)?"Edit":"Add") ?> Pages
                    </th>
                </tr>
                <tr>
                    <td>Image</td>
                    <td><?php if(!empty($resultArr)){ ?>
                        <img src="<?=$this->config->item('pages_url').'t_'.$resultArr['image']?>" />
                    <?php } ?>
                ...
                <tr>
                    <td>Slug Name</td>
                    <td><input readonly type="type" class="form-control" value="<?=(!empty($resultArr)?$resultArr['slugName']:"")?>" name="slugName" /></td>
                </tr>
                <tr>
                    <td>Description</td>
