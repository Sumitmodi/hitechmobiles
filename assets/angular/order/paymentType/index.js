app.controller('kendoCtrl',function($scope,$requestFactory) {
    ...
    var dataSource = new kendo.data.DataSource({
        transport: {
            read: {
                url: base + 'api/order/product_types?apikey='+apikey,
                dataType: "json"
            },
            create: {
                url: base + 'api/order/product_types',
                type: "POST",
                dataType: "json"
            },
            update: {
            ...
            destroy: {
                ...
                url: base + 'api/order/delete_product_type',
    ...
    $scope.deleteSelected = function () {
        ...
        if (ids.length > 0) {
            ...
            if (confirm("Are you sure you want to delete " + ids.length + " payment type?") === false) {
            ...
            hitech.request({
                ...
                complete: function (result) {
                    ...
                    if (result.code == 200) {
                        ...
                        $.notify("Selected payment type were deleted successfully.", {
                        ...
                        $.notify("Selected payment type could not be deleted.", {
            ...
            $.notify("Please select at least one payment type.", {
            ...
            first: {
                ...
                complete: function (result) {
                    ...
                    if (result.code === 200) {
                        ...
                        $.notify("Payment type have been reset successfully.", {
                        ...
                        hitech.request({
                            ...
                            complete: function (res) {
                                ...
                                if (res != false) {
                                    ...
                                    $.notify("Payment type have been reloaded.", {
                                    ...
                                    $.notify("Payment type could not be reloaded.", {
                        ...
                        $.notify("Payment type could not be reset.", {
